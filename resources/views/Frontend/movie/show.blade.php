             ...
             @if ($loop->index <5)
                <div class="mt-8">
                    @if ($cast['profile_path'] != null)
                        <a href="#">
                            <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$cast['profile_path']}}"  style="height:400px;width:300px;" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a> 
                    @else
                        <a href="{{route('actors.show',$cast['id'])}}">
                            <img src="{{asset('images/defaultprofile.jpg')}}" style="height:400px;width:300px;" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a> 
                    @endif
